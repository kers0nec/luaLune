...
export const PLANS = {
  free: {
    ...
    features: ["LuaLune Obfuscator (payload)", "LuaLune Obfuscator - Flow", "LuaLune Obfuscator - Vault", "Public loader URLs", "Key system (5 keys)"],
  },
  pro: {
    id: "pro",
    name: "Pro",
    ...
    features: ["Everything in Free", "25 protected scripts", "500 builds per month", "Execution logs", "Workspace sharing", "HWID whitelist", "Anti-tamper builds"],
  },
  premium: {
    id: "premium",
    name: "Premium",
    ...
    features: ["Everything in Pro", "Unlimited scripts and builds", "Unlimited keys and whitelist entries", "Priority build queue", "API access", "Vault engine with decoy records"],
  },
};
